...
async def login(creds: LoginCredentials, session: Annotated[AsyncSession, Depends(get_db)]):
    ...
    # Architectural Override: Central IT (unbound users) inherit global visibility
...
print("[+] Auth logic overwritten. Super Admin global permissions mathematically guaranteed.")