...
# 1. Delete the ghost file
bad_file = "app/api/v1/endpoints/tenants.py"
if os.path.exists(bad_file):
    os.remove(bad_file)
    print("[*] Deleted rogue tenants.py file.")

# 2. Overwrite the correct file with full logic and auth dependencies
content = """
...
with open("app/api/v1/endpoints/tenant.py", "w", encoding="utf-8") as f:
    f.write(content.strip() + "\n")

print("[+] Repaired filename mismatch. tenant.py safely overwritten.")